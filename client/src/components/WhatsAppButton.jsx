...
const WhatsAppButton = () => {
  ...
  const phoneNumber = "13157467760";
  const whatsappUrl = `https://wa.me/${phoneNumber}`;
  
  // ✅ Message par défaut
  const defaultMessage = "Bonjour, je viens de la part de Peptide Weight Loss. J'aimerais avoir plus d'informations sur vos produits.";
  const whatsappUrlWithMessage = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(defaultMessage)}`;

  // Cacher le bouton après défilement
  useEffect(() => {
    let timeoutId;
